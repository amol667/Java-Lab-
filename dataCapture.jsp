...
<br>Last Name: <input type="text" size="15" name="lname"/> 
Select your Place of Work: <select name="profession" size="3">
...
<br> <FONT COLOR="Red"> Annual Income(in Rupees):</FONT> <input type="text" size="15" name="income"/> <br> <br> 
